...
\begin{table}
	\centering
	\scalebox{0.8}{%
	\input{tables/table_regression_workplaces_avg_7d.tex}
}
\end{table}
...
\begin{table}
	\centering
	\scalebox{0.8}{%
		\input{tables/table_regression_transit_stations_avg_7d.tex}
	}
\end{table}
...
\begin{table}
	\centering
	\scalebox{0.8}{%
		\input{tables/table_regression_retail_and_recreation_avg_7d.tex}
	}
\end{table}
...
\begin{table}
	\centering
	\scalebox{0.8}{%
		\input{tables/table_regression_grocery_and_pharmacy_avg_7d.tex}
	}
\end{table}
...
\begin{table}
	\centering
	\scalebox{0.8}{%
		\input{tables/table_regression_residential_avg_7d.tex}
	}
\end{table}
